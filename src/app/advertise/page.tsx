...
const packages = [
  {
    ...
    period: "one-time",
    description:
      "A sponsored article that looks like a news story — the most effective way to reach Flint residents.",
    features: [
      "Custom written article about your business",
      "Published in our news feed",
      "Shared to our 10K+ Facebook audience",
      "Included in daily email newsletter",
      "Permanent link on the site",
    ],
    popular: true,
  },
  {
    ...
    period: "/month",
    description:
      "Your business featured in our Business Directory with a highlighted listing.",
    features: [
  ...
  },
  {
    ...
    period: "/week",
    description:
      "Your business name and message at the top of our daily email newsletter.",
    features: [
      "\"Sponsored by [Your Business]\" header",
  ...
  },
  {
    ...
    period: "one-time",
    description:
      "Highlight your event with a featured badge and top placement on our Events page.",
    features: [
      "Featured badge on your event",
      "Top placement on Events page",
      "Included in weekly events email",
    ...
    <div>
      ...
      <section className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 py-14 text-center">
          <h1 className="text-4xl font-black mb-3">
            Put Your Business in Front of Flint
          </h1>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Reach thousands of engaged Flint residents every day through
            sponsored content, featured listings, and newsletter sponsorships.
          </p>
          <div className="flex flex-wrap justify-center gap-6 mt-8 text-sm">
            <div className="text-center">
              <div className="text-3xl font-black text-red-500">10K+</div>
              <div className="text-gray-400">Facebook Followers</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-black text-red-500">5K+</div>
              <div className="text-gray-400">Email Subscribers</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-black text-red-500">50K+</div>
              <div className="text-gray-400">Monthly Page Views</div>
            </div>
          </div>
        </div>
      </section>
          ...
          {packages.map((pkg) => (
            <div
              ...
              className={`bg-white rounded-xl border-2 p-6 flex flex-col ${
                pkg.popular
                  ? "border-red-600 shadow-lg relative"
                  : "border-gray-200"
              }`}
            >
              {pkg.popular && (
      ...
      <section className="bg-white border-y border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-14">
          <h2 className="text-2xl font-black text-gray-900 text-center mb-10">
            Why Advertise With Flint Police Ops?
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-14 h-14 bg-red-100 text-red-600 rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                1
              </div>
              ...
              <p className="text-gray-500 text-sm">
                Our audience is 100% Flint and Genesee County residents — the
            ...
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm">
                Flint Police Ops is the community&apos;s go-to for news. Your
                business benefits from that trust and credibility.
              </p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 bg-red-100 text-red-600 rounded-xl flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
              ...
              <p className="text-gray-500 text-sm">
                Sponsored posts blend naturally into news content. Your message
                gets read, not ignored like banner ads.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="What does your business do? What would you like to promote?"
