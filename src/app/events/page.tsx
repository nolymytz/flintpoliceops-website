...
export const metadata = {
  ...
  description:
    "Upcoming events, community gatherings, and things to do in Flint, Michigan.",
};
    ...
    <div className="max-w-7xl mx-auto px-4 py-10">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-gray-500">
            Community events, meetings, and things to do in Flint &amp; Genesee
            County.
          </p>
        </div>
        <Link
          href="/submit"
          className="inline-flex bg-red-600 hover:bg-red-700 text-white text-sm font-semibold px-5 py-2.5 rounded-lg transition-colors whitespace-nowrap"
        >
          + Submit an Event
        </Link>
      </div>
      ...
      <div className="mt-10 bg-gray-50 border border-gray-200 rounded-xl p-8 text-center">
        ...
        <p className="text-gray-500 mb-4 max-w-md mx-auto">
          Submit your community event, business opening, fundraiser, or meetup.
          Featured events reach thousands of Flint residents.
        </p>
